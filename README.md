...
| 2022 | <a href="https://better-flow.github.io/evimo/download_evimo_2.html" target="_blank"> EVIMO2 </a>                           | Prophesee Gen3, DVS Gen3     | Yes, Automatic labeling     | Moving objects                                     | Indoor dataset with moving objects, 3D motion of the sensor, 3D motion of all objects, structure of the object and scene, masks of the objects, and optical flow | Indoor dataset with moving objects, 3D motion of the sensor, 3D motion of all objects, structure of the object and scene, masks of the objects, and optical flow |
