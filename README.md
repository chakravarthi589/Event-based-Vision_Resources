...
| Our Datasets | Dataset Description| Type   | Event-Modality | Annotations | Object Class | Lighting | Weather |
|--------------|--------------------|--------|----------------|-------------|-------------------------|---------|
...
| SEVD  | Fixed and Ego perception Multiview Multi-Modality (RGB, Depth, Optical, Semantic, Instance) traffic data | Synthetic | Carla DVS | 2D & 3D Bounding Box | Vehicle, Pedestrian, Micro-mobility | Daytime, Nighttime, Twilight, Domain shifts | Clear, Cloudy, Wet, Soft Rainy, Hard Rainy, Foggy |
---
