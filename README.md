...
| 2019 | <a href="https://better-flow.github.io/evimo/" target="_blank"> EVIMO </a? | DAVIS346 | Yes, Automatic labeling | Moving objects | motion segmentation, structure from motion, visual odometry, optical flow, and stereo |  Indoor dataset with moving objects, the 3D motion of the sensor, the 3D motion of all objects, the structure of the object, masks of the objects |
